# WeKws On-device ASR Android Demo

This Android demo shows we can run on-device streaming key word spotting with WeKws. You can download our prebuilt APK or build your APK from source code.
...
Or you can train your own model using WeKws training pipeline on your data.
...
``` sh
cd runtime/device/android/wekws
./gradlew build
```
